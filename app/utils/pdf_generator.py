...
def generate_pdf_report(
    ...
    if match_score >= 80:
        recommendation = (
            ...
            "You are well prepared for job applications."
        )
    elif match_score >= 60:
        recommendation = (
            "Your resume is moderately aligned with the selected role. "
            "Focus on improving the missing skills to increase your chances."
        )
    else:
        recommendation = (
            "Significant skill gaps were identified. "
            "It is recommended to learn the missing skills before applying."
        )
        content.append(
            Paragraph(
                recommendation,
